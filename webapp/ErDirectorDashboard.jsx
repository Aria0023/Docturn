...
function ErDirectorDashboard({ erPhysicians, shifts, sent, board, diversion, avgAcceptSec, onToggle, onUpdate, onSetShift, onAdd, onRemove, onToggleDiversion, onBroadcasts }) {
  ...
  return (
    <PageWrap>
      {/* diversion banner */}
      <div style={{ display: "flex", alignItems: "center", gap: 12, padding: "12px 16px", marginBottom: 18, borderRadius: "var(--radius-md)",
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1.3fr .9fr", gap: 16, alignItems: "start", marginTop: 16 }}>
        {/* ER physician roster */}
...
Object.assign(window, { ErDirectorDashboard });
